...
\section{Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages} {\cplusplus, python, bash}
...
\end{comment}
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeSubHeadingEnvironment{\cplusplus, Qt/QtCreatorIDE, python, bash, Agile, mercurial, git, CAN-protocol, sqlite-db, TestDrivenDevelopment(TDD), gtest, Squish(UI-Testing), Cucumber, gperf, valgrind}
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeSubHeadingEnvironment{\cplusplus, Linux  IPCs,  Multi-threading, Windriver  Linux,  PowerPC,  bash  scripting,  PVCS(version control), sqlite-db, awk, sed, valgrind}
