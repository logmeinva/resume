...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeSubHeadingEnvironmentAndTools{\cplusplus, Qt/QtCreatorIDE, python, bash, Multithreading, Agile, mercurial, git, CAN-protocol, sqlite-db, TestDrivenDevelopment(TDD), gtest, Squish(UI-Testing), Cucumber, gperf, valgrind, yum(package manager)}
